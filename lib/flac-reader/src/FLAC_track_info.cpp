...
size_t FLAC_info_size (FLAC_track_info *track_info) {
	size_t info_size = 0;

	info_size += track_info->album.size();
	info_size += track_info->genre.size();
	info_size += track_info->date.size();
	info_size += track_info->title.size();
	info_size += track_info->comment.size();
	info_size += track_info->artist.size();
	info_size += track_info->album_artist.size();

	info_size += sizeof(track_info->hash);
